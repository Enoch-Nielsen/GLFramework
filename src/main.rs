...
fn main() 
{   
	let mut window_size : Vector2 = Vector2 {x: 1500.0, y: 1000.0};
	...
	let rect_color : Vector4 = Vector4::new(0.0, 1.0, 1.0, 1.0);
	let mut ob : RenderableObject = RenderableObject::new(Vector2{x: 100.0, y: 200.0}, Vector2{x: 100.0, y: 100.0}, 20.0, rect_color,
		window_size.clone(), 0);

	let circle_color : Vector4 = Vector4::new(0.0, 1.0, 0.0, 1.0);
	let mut ab : RenderableObject = RenderableObject::new(Vector2{x: 300.0, y: 600.0}, Vector2{x: 200.0, y: 100.0}, 0.0, circle_color,
		window_size.clone(), 1);
